...
[View the demo](http://practicube.com/photogroup/index.html).
...
## Dependencies:
Requires [jQuery](http://jquery.com/download/) and the [jQuery Transit plugin](https://github.com/rstacruz/jquery.transit).
